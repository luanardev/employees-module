...
class EmploymentStatusTable extends DataTableComponent
{
	...
	{
		return $this->emit('create-employment-status');
	}
    ...
    public function editAction()
	{
		if(count($this->selectedKeys)){
			...
			return $this->emit('edit-employment-status', $key);
		}
	}
	...
	{
		if(count($this->selectedKeys)){
			return $this->emit('delete-employment-status', $this->selectedKeys) ;
		}
	}
