...
class EmployeeCategoryTable extends DataTableComponent
{
	...
	{
		return $this->emit('create-employee-category');
	}
    ...
    public function editAction()
	{
		if(count($this->selectedKeys)){
			...
			return $this->emit('edit-employee-category', $key);
		}
	}
	...
	{
		if(count($this->selectedKeys)){
			return $this->emit('delete-employee-category', $this->selectedKeys) ;
		}
	}
