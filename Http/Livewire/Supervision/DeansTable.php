...
use Luanardev\Modules\Employees\Entities\DeanshipView;
use Luanardev\LivewireAlert\WithLivewireAlert;

class DeansTable extends DataTableComponent
{
	...
	{
		return DeanshipView::getByCampus()
