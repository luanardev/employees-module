...
use Luanardev\Modules\Employees\Entities\HeadshipView;
use Luanardev\LivewireAlert\WithLivewireAlert;

class HeadsTable extends DataTableComponent
{
	...
	{
		return HeadshipView::getByCampus()
