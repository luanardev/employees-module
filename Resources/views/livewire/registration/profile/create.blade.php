                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" wire:model.lazy="employee.id" name="id" class="form-control" placeholder="Enter Employee ID" />
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="email" wire:model.lazy="employee.official_email" name="official_email" class="form-control " placeholder="Enter Official Email" />
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" wire:model.lazy="employee.home_authority" name="home_ta" class="form-control " placeholder="Enter Home TA">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
