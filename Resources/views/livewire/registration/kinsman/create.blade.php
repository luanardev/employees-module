        ...
        <form wire:submit.prevent="save">
            ...
            <div class="card-header">
                ...
                <div class="float-right">
                    ...
                    <button type="button" wire:click="copySpouse()"class=" btn btn-sm btn-success">
                        <i class="fas fa-user"></i> Spouse
                    </button>

                    <button type="button" wire:click="resetSpouse()"class=" btn btn-sm btn-secondary">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <select wire:model.lazy="kinsman.title" name="title" class="form-control select2"  >
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <select wire:model.lazy="kinsman.relation" name="relation" class="form-control select2"  >
                                <option value="">--select--</option>
